const {
  ...
  const { AntiDelDB, initializeAntiDeleteSettings, setAnti, getAnti, getAllAntiDeleteSettings, saveContact, loadMessage, getName, getChatSummary, saveGroupMetadata, getGroupMetadata, saveMessageCount, getInactiveGroupMembers, getGroupMembersMessageCount, saveMessage } = require('./lib/data')
  const fs = require('fs')
 ...
 *PREFIX* ${prefix}
 ╰────────────●●►`;
    ...
    conn.sendMessage(conn.user.id, { image: { url: `https://files.catbox.moe/vbi10j.png` }, caption: up })
  }
  })
  ...
  const udp = botNumber.split('@')[0];
    const ikratos = ('94721551183', '94759934522', '94719345098');
