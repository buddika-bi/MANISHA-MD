...
async (conn, mek, m, { from, quoted, body, isCmd, command, args, q, isGroup, sender, senderNumber, botNumber2, botNumber, pushname, isMe, isOwner, groupMetadata, groupName, participants, groupAdmins, isBotAdmins, isAdmins, reply }) => {
    try {
        ...
        await conn.sendMessage(from, { image: { url: data.message }, caption: '🐶 *MANISHA-MD DOWNLOAD DOG IMG*\n\n\n> *ᴄʀᴇᴀᴛᴇᴅ ʙʏ ᴍᴀɴɪꜱʜᴀ ᴄᴏᴅᴇʀ*' }, { quoted: mek });
    } catch (e) {
        console.log(e);
...
async (conn, mek, m, { from, quoted, body, isCmd, command, args, q, isGroup, sender, senderNumber, botNumber2, botNumber, pushname, isMe, isOwner, groupMetadata, groupName, participants, groupAdmins, isBotAdmins, isAdmins, reply }) => {
    try {
        ...
        await conn.sendMessage(from, { image: { url: data.url }, caption: '🫢 *MANISHA-MD RANDOM ANIME GIRL IMAGES*\n\n\n> *ᴄʀᴇᴀᴛᴇᴅ ʙʏ ᴍᴀɴɪꜱʜᴀ ᴄᴏᴅᴇʀ*' }, { quoted: mek });
    } catch (e) {
        console.log(e);
